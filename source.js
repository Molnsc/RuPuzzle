...
<body>
  <div id="header_div">
    ...
    <title>RuPuzzle V1.0.3 By DontBanRussians</title>
    <div id="title_div">
      <p style="font-size: 16px"><b>${media.title + "  [Made By DontBanRussians]"}</b></p>
       <p style="font-size: 14px"><b>RuPuzzle V1.0.3</b></p>
      <p style="font-size: 12px">Version: 1.0.3 / Model: ZipV3 / Released: 6/6/2024</p>
      ...
      <input id="skipper" type="button" value="Skip Video" onclick="skip_video();" class="button" disabled/>
      <input id="answers_button" type="button" value="Answer Questions" onclick="answer_questions();" class="button" disabled/>
      <div id="speed_container" hidden>
        <label style="font-size: 12px" for="speed_dropdown">Video speed:</label>
        <select name="speed_dropdown" id="speed_dropdown" onchange="video_speed()" class="button">
